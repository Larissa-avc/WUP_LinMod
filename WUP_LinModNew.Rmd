...
P value is less than 0.05 therefore model 1 and model 2 are different. model 2 is better 
...
the p value is less than 0.05 therefore model 2 and model 3 are different
